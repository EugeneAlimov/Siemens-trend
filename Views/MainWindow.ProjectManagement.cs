...
namespace SiemensTrend.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void CreateNewProject()
        {
            try
            {
                // Здесь можно добавить логику создания нового проекта
                _logger.Info("Создание нового проекта");
                MessageBox.Show("Функция создания нового проекта находится в разработке",
                    "Информация", MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
                _logger.Error($"Ошибка при создании нового проекта: {ex.Message}");
                MessageBox.Show($"Ошибка при создании нового проекта: {ex.Message}",
                    "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
